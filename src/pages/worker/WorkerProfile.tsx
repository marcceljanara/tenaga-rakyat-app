            ...
            <Card>
                <CardContent className="p-6">
                    ...
                    <p className="text-sm text-secondary-500 mb-4">
                        Lokasi Anda akan membantu pemberi kerja menemukan pekerja terdekat.
                ...
                <CardContent className="p-6">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <div>
                            ...
                            />
                            <p className="text-sm text-secondary-500 mt-1">Deskripsi kasar lokasi Anda (tidak perlu detail)</p>
                        </div>
