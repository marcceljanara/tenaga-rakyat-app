...
export const EmployerProfile: React.FC = () => {
    ...
    return (
        <div className="max-w-2xl space-y-6 animate-fade-in">
            {/* Header */}
            <div>
                <h1 className="text-2xl font-bold text-secondary-900">Profil Pemberi Kerja</h1>
                <p className="text-secondary-600">Kelola informasi profil dan foto perusahaan/bisnis Anda</p>
            </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        <div>
                            <div className="flex items-center gap-2 mb-1.5">
                                ...
                                <label className="text-sm font-medium text-secondary-700">Nama Perusahaan / Pemberi Kerja</label>
                            </div>
                            <Input
                                {...register('full_name')}
                                placeholder="Nama perusahaan atau nama Anda"
                        ...
                        <Textarea
                            {...register('about')}
                            label="Tentang Perusahaan/Bisnis"
                            placeholder="Ceritakan tentang perusahaan atau bisnis Anda, bidang usaha, dan jenis pekerjaan yang sering ditawarkan..."
                            rows={4}
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-1.5">
                                ...
                                <label className="text-sm font-medium text-secondary-700">Link Profil</label>
                            </div>
                            <Input
                                {...register('cv_url')}
                                placeholder="https://website-perusahaan.com atau profil linkedin"
                                error={errors.cv_url?.message}
                            />
                            <p className="text-sm text-secondary-500 mt-1">Link website perusahaan, profil LinkedIn, atau halaman bisnis Anda</p>
                        </div>
