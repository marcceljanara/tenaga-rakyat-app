                        ...
                        <div className="space-y-10 text-secondary-700 leading-relaxed text-base">
                            ...
                            <section id="definisi" className="scroll-mt-24 space-y-4">
                                ...
                                <ul className="list-disc list-outside pl-5 space-y-3">
                                    ...
                                    <li>
                                        <strong>Pembelian Kuota Publikasi (Top-Up Credit Posting):</strong> Untuk dapat mempublikasikan lowongan pekerjaan, Pemberi Kerja dapat membeli kuota publikasi lowongan melalui skema transfer bank manual secara langsung (*cash offline* / bank transfer) yang akan dikonfirmasi secara manual oleh Admin.
                                    </li>
                                    <li>
                                        <strong>Penyelesaian Transaksi Kerja:</strong> Pekerjaan diselesaikan langsung di lapangan secara offline. Seluruh pembayaran upah diselesaikan secara langsung di antara pengguna (tunai/transfer langsung) tanpa adanya penampungan dana sementara (*escrow*) atau dompet digital (*wallet*) di dalam aplikasi.
                                    </li>
                                    <li>
                            ...
                            <section id="penerimaan" className="scroll-mt-24 space-y-4">
                                ...
                                <ul className="list-disc list-outside pl-5 space-y-3">
                                    ...
                                    <li>
                                        Pengguna wajib memberikan informasi yang akurat, lengkap, dan terkini saat pendaftaran, serta menjaga kerahasiaan kata sandi (*password*) akun Anda.
                                    </li>
                                    <li>
                            ...
                            <section id="hak-kewajiban" className="scroll-mt-24 space-y-4">
                                ...
                                <ul className="list-disc list-outside pl-5 space-y-3">
                                    ...
                                    <li>
                                        <strong>Penyalahgunaan Platform:</strong> Pengguna dilarang menyalahgunakan sistem pembelian kuota publikasi (*Top-Up Credit Posting*), termasuk namun tidak terbatas pada mengirimkan bukti pembayaran palsu atau melakukan kecurangan saat pengisian saldo kredit lowongan.
                                    </li>
                                    <li>
                                ...
                                <ul className="list-disc list-outside pl-5 space-y-3">
                                    <li>
                                        ...
                                        <ul className="list-circle list-outside pl-5 mt-2 space-y-2">
                                            <li>Masalah teknis di luar kendali wajar kami (misalnya server *down*, gangguan jaringan internet, atau *force majeure*).</li>
                            ...
                            <section id="penutupan" className="scroll-mt-24 space-y-4">
                                ...
                                <ul className="list-disc list-outside pl-5 space-y-3">
                                    ...
                                    <li>
                                        Kami berhak sepenuhnya untuk menangguhkan (*suspend*) atau menghapus akun pengguna secara sepihak tanpa pemberitahuan sebelumnya, apabila ditemukan indikasi pelanggaran terhadap Syarat & Ketentuan ini atau adanya aduan valid mengenai penipuan dan perbuatan tidak menyenangkan.
                                    </li>
                                </ul>
                            </section>
